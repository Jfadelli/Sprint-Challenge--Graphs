...
class Hero:
	...
	def update_traversal_graph(self):
		# input: 	current room
		# output: 	create new, initialized entries for traversal graph
	...
	def reverse(self, direction):
		# input: 	single cardinal direction // returns: opposite cardinal direction when called
	...
	def add_directions(self, last_direction):
		...
		self.direction_stack.push((self.reverse(last_direction), "visited"))
